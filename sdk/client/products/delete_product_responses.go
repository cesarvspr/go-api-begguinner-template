...
func (o *DeleteProductNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(DeleteProductNotFoundBody)
...
/*DeleteProductNotFoundBody delete product not found body
...
// Validate validates this delete product not found body
func (o *DeleteProductNotFoundBody) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this delete product not found body based on context it is used
func (o *DeleteProductNotFoundBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (o *DeleteProductNotFoundBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *DeleteProductNotFoundBody) UnmarshalBinary(b []byte) error {
	var res DeleteProductNotFoundBody
